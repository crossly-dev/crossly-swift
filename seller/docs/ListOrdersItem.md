...
**handlingTimeDays** | **Double** |  | [optional] 
...
**labelPurchasedAt** | **Date** |  | [optional] 
...
**trackingHistory** | [ListOrdersItemTrackingHistory] |  | [optional] 
**deliveryLocation** | **String** |  | [optional] 
**deliverySignature** | **String** |  | [optional] 
**trackingSubmittedAt** | **Date** |  | [optional] 
...
**shipByAt** | **Date** |  | [optional] 
**shipByAlertedAt** | **Date** |  | [optional] 
**oversoldBy** | **Double** |  | 
**lastStatusCheckAt** | **Date** |  | [optional] 
**lastChatCheckAt** | **Date** |  | [optional] 
**isDisputed** | **Bool** |  | 
**disputeReason** | **String** |  | [optional] 
**disputePlatformCaseId** | **String** |  | [optional] 
**disputeResolvedAt** | **Date** |  | [optional] 
**refundAmount** | **String** |  | [optional] 
**refundReason** | **String** |  | [optional] 
**refundPlatformId** | **String** |  | [optional] 
**refundedAt** | **Date** |  | [optional] 
**cancellationReason** | **String** |  | [optional] 
**arrivalConditionRequestedAt** | **Date** |  | [optional] 
**arrivalConditionSubmittedAt** | **Date** |  | [optional] 
**arrivalConditionDeclinedAt** | **Date** |  | [optional] 
